...
export default function OfferNotificationPopup({ alert, onDismiss }: Props) {
  ...
  return (
    <div
      ...
      className="fixed left-3 right-3 z-[12000] mx-auto max-w-md rounded-2xl border border-[#007782]/30 bg-white p-4 shadow-2xl top-[calc(3rem+env(safe-area-inset-top,0px))] md:left-auto md:right-4 md:top-16"
    >
      <button
        type="button"
        onClick={onDismiss}
      ...
      <h2 id="offer-alert-title" className="mt-1 pr-8 text-base font-bold text-gray-900 leading-snug">
