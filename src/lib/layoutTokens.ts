...
/** Mobil bottom nav: fő sor (3.75rem) + értesítés sor (~2.5rem) + safe area */
export const MOBILE_BOTTOM_NAV_HEIGHT = 'calc(6.25rem + env(safe-area-inset-bottom, 0px))';
...
export const MOBILE_PAGE_BOTTOM_CLASS =
  'pb-[calc(6.25rem+env(safe-area-inset-bottom,0px))] md:pb-12';
